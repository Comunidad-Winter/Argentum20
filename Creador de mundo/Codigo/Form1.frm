...
SavePicture Imagen, App.Path & "\exportación\mapa" & MundoSeleccionado & ".bmp"
...
MundoSeleccionado = Form1.Combo1.ListIndex + 1
Form1.txtancho = Mundo(MundoSeleccionado).Ancho
Form1.txtalto = Mundo(MundoSeleccionado).Alto

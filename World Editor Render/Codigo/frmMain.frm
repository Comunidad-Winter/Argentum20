...
Begin VB.Form frmMain 
   ...
   Begin VB.Timer Timer2 
      ...
      Top             =   1560
   End
   Begin VB.CommandButton MiniMap 
      Caption         =   "MiniMapas"
      Height          =   375
      Left            =   13680
      TabIndex        =   101
...
If index = 5 And Timer1.Enabled = True Then
...
If (index + NumMap_Save - 4) <> NumMap_Save Then
    ...
    Dialog.FileName = PATH_Save & NameMap_Save & (index + NumMap_Save - 4) & ".csm"
...
With Dialog
    .Filter = "Mapas de Argentum Online (*.map)|*.csm"
    If Guardar Then
            .DialogTitle = "Guardar"
            .DefaultExt = ".txt"
...
RenderToPicture 4, True
Call MapPest_Click(5)
End Sub

Private Sub Timer2_Timer()
RenderToMiniMap 5, True
Call MapPest_Click(5)
End Sub

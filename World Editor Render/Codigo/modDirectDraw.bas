...
Sub MakeChar(CharIndex As Integer, Body As Long, Head As Long, Heading As Byte, X As Integer, y As Integer)
'*************************************************
'Author: Unkwown
...
'*************************************************
   If LenB(strText) <> 0 Then
    'BackBufferSurface.SetFontñTransparency True                           'Set the transparency flag to true

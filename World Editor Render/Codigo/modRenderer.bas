...
frmRenderer.Picture1.Width = 32 * 75 * Screen.TwipsPerPixelX
frmRenderer.Picture1.Height = 32 * 80 * Screen.TwipsPerPixelY
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''
If RenderToBMP Then
    SavePicture frmRenderer.Picture1.Picture, App.Path & "\Render\" & frmMain.MapPest(4).Caption & ".bmp"
Else
    Set C = New cDIBSection
    C.CreateFromPicture frmRenderer.Picture1.Picture
    Call SaveJPG(C, App.Path & "\" & frmMain.MapPest(4).Caption & ".jpg")
    Set C = Nothing
End If
''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
End Sub
Sub RenderToMiniMap(Optional Ratio As Integer = 1, Optional RenderToBMP As Boolean = False)
'*************************************************
'Author: Salvito
'*************************************************
'On Error GoTo Error:
...
Next y
    ...
    DoEvents
frmRenderer.Picture1.AutoRedraw = True
frmRenderer.Picture1.Width = 32 * 100 * Screen.TwipsPerPixelX

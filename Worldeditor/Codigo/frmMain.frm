...
Begin VB.Form FrmMain 
   ...
   ScaleWidth      =   1622
   Visible         =   0   'False
   Begin WorldEditor.lvButtons_H LvBMundo 
      Height          =   375
      Index           =   23
      Left            =   22320
      TabIndex        =   193
   ...
   Begin VB.Frame Frame1 
      ...
      Begin WorldEditor.lvButtons_H LvBOpcion 
         ...
         cBack           =   -2147483633
      End
      Begin WorldEditor.lvButtons_H LvBToolsHaracin 
         Height          =   375
         Index           =   23
         Left            =   3840
         TabIndex        =   194
   ...
   Begin VB.Menu ladder 
      ...
      End
      Begin VB.Menu mnuCapa1 
         Caption         =   "Pegar solo capa 1"
         Shortcut        =   ^{F1}
      End
      Begin VB.Menu mnuCapa2 
         Caption         =   "Pegar solo capa 2"
         Shortcut        =   ^{F2}
      End
      Begin VB.Menu mnuCapa3 
         Caption         =   "Pegar solo capa 3"
         Shortcut        =   ^{F3}
      End
      Begin VB.Menu mnuCapa4 
         Caption         =   "Pegar solo capa 4"
         Shortcut        =   ^{F4}
      End
   End
...
Private Sub LvBMundo_Click(Index As Integer)
    Call FrmMundo.Show
End Sub

Private Sub LvBToolsHaracin_Click(Index As Integer)
    Radio = 1
...
Private Sub mnuCapa1_Click()
    Call PegarSeleccionCapa1
End Sub

Private Sub mnuCapa2_Click()
    Call PegarSeleccionCapa2
End Sub

Private Sub mnuCapa3_Click()
    Call PegarSeleccionCapa3
End Sub

Private Sub mnuCapa4_Click()
    Call PegarSeleccionCapa4
End Sub
...
Private Sub LvBOpcion_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 8
            ...
            'Norte
            Call CopiarEspejado(1, 100, 11, 22) 'Command1_Click copio para pegar al Norte
            Call PegarEspejado("Norte") 'pego en el norte
            ' copio el de arriba al oeste
            Call CopiarEspejado(14, 27, 1, 100) 'Command2_Click copio para pegar en Oeste
            Call PegarEspejado("Oeste") 'pego en el Oeste
            ' vuelvo
            Call CopiarEspejado(75, 87, 1, 100) 'Command3_Click copio para pegar al Este
            Call PegarEspejado("Este") ' pego en el Este
            'copio al sur
            Call CopiarEspejado(1, 100, 81, 90) 'Command4_Click copia para pegar al Sur
            Call PegarEspejado("Sur") 'pego en el Sur
            'Oeste
            Call CopiarEspejado(14, 27, 1, 100) 'Command2_Click copio para pegar en Oeste
            Call PegarEspejado("Oeste") 'pego en el Oeste
            'copio sur y vuelvo
...
Private Sub cmdInformacionDelMapa_Click()
    ...
    UserMap = Label16.Caption
    Call CargarZonas
    
    If SeleccionIX > 0 And NumZonas > 0 Then
        AgregarZona = 3
        frmMapInfo.txtIrZona.Text = NumZonas + 1
        frmMapInfo.tZX1.Text = SeleccionIX
        frmMapInfo.tZX2.Text = SeleccionFX
        frmMapInfo.tZY1.Text = SeleccionIY
        frmMapInfo.tZY2.Text = SeleccionFY
    End If
    
    frmMapInfo.Show
    frmMapInfo.Visible = True
    MapaActual = FrmMain.Label16.Caption
    Call frmMapInfo.cmdIraZona_Click
    Exit Sub
...
Public Function CopiarEspejado(ByVal IX As Integer, ByVal fX As Integer, ByVal IY As Integer, ByVal fY As Integer)
...
Public Function PegarEspejado(ByVal Direccion As String)

    Call Form2.VerMapaTraslado

Select Case Direccion
    
    Case "Norte"
        If Form2.lblMapaNorte.Caption <> "Norte" Then
            If FileExist(PATH_Save & NameMap_Save & CLng(Form2.lblMapaNorte.Caption) & ".csm", vbArchive) = True Then
                Call modMapIO.NuevoMapa
                FrmMain.Dialog.FileName = PATH_Save & NameMap_Save & CLng(Form2.lblMapaNorte.Caption) & ".csm"
        ...
        End If
    Case "Sur"
         If Form2.lblMapaSur.Caption <> "Sur" Then
            If FileExist(PATH_Save & NameMap_Save & CLng(Form2.lblMapaSur.Caption) & ".csm", vbArchive) = True Then
                Call modMapIO.NuevoMapa
                FrmMain.Dialog.FileName = PATH_Save & NameMap_Save & CLng(Form2.lblMapaSur.Caption) & ".csm"
                modMapIO.AbrirMapa FrmMain.Dialog.FileName
                FrmMain.mnuReAbrirMapa.Enabled = True
                SobreX = 1
                SobreY = 1
        ...
        End If
    Case "Este"
         If Form2.lblMapaEste.Caption <> "Este" Then
            If FileExist(PATH_Save & NameMap_Save & CLng(Form2.lblMapaEste.Caption) & ".csm", vbArchive) = True Then
                Call modMapIO.NuevoMapa
                FrmMain.Dialog.FileName = PATH_Save & NameMap_Save & CLng(Form2.lblMapaEste.Caption) & ".csm"
                modMapIO.AbrirMapa FrmMain.Dialog.FileName
                FrmMain.mnuReAbrirMapa.Enabled = True
                SobreX = 1
                SobreY = 1
        ...
        End If
    Case "Oeste"
        If Form2.lblMapaOeste.Caption <> "Oeste" Then
            If FileExist(PATH_Save & NameMap_Save & CLng(Form2.lblMapaOeste.Caption) & ".csm", vbArchive) = True Then
                Call modMapIO.NuevoMapa
                FrmMain.Dialog.FileName = PATH_Save & NameMap_Save & CLng(Form2.lblMapaOeste.Caption) & ".csm"
                modMapIO.AbrirMapa FrmMain.Dialog.FileName
                FrmMain.mnuReAbrirMapa.Enabled = True
                SobreX = 88
                SobreY = 1
...
End Select
        ...
        Debug.Print Form2.lblMapaSur.Caption
        Debug.Print FrmMain.Dialog.FileName
...
For i = 1 To NumAreas
    If Areas(i).Mapa = UserMap Then
        MiniMap.Line (Areas(i).X1, Areas(i).Y1)-(Areas(i).X2, Areas(i).Y1)
        MiniMap.Line (Areas(i).X1, Areas(i).Y2)-(Areas(i).X2, Areas(i).Y2)
        MiniMap.Line (Areas(i).X1, Areas(i).Y1)-(Areas(i).X1, Areas(i).Y2)
        MiniMap.Line (Areas(i).X2, Areas(i).Y1)-(Areas(i).X2, Areas(i).Y2)
    End If
Next i
End Sub
Sub DibujarZonas()
...
For i = 1 To NumZonas
    If Zonas(i).Mapa = UserMap Then
        MiniMap.Line (Zonas(i).X1, Zonas(i).Y1)-(Zonas(i).X2, Zonas(i).Y1)
        MiniMap.Line (Zonas(i).X1, Zonas(i).Y2)-(Zonas(i).X2, Zonas(i).Y2)
        MiniMap.Line (Zonas(i).X1, Zonas(i).Y1)-(Zonas(i).X1, Zonas(i).Y2)
        MiniMap.Line (Zonas(i).X2, Zonas(i).Y1)-(Zonas(i).X2, Zonas(i).Y2)
    End If
Next i
End Sub

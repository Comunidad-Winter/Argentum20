...
Sub DobleClick(tX As Integer, tY As Integer)
    ...
    Dim i As Integer
        ...
        For i = 1 To NumZonas
            If Zonas(i).Mapa = MapaActual Then
                If (Zonas(i).X1 <= tX And Zonas(i).X2 >= tX) And (Zonas(i).Y1 <= tY And Zonas(i).Y2 >= tY) Then
                    frmMapInfo.Show
                    frmMapInfo.txtIrZona = i
                    ...
                    frmMapInfo.txtMapTerreno.Text = Zonas(i).Terreno


                    frmMapInfo.chkMapMagiaSinEfecto.Value = Zonas(i).MagiaSinEfecto
                    frmMapInfo.chkMapInviSinEfecto.Value = Zonas(i).InviSinEfecto
                    frmMapInfo.chkMapResuSinEfecto.Value = Zonas(i).ResuSinEfecto
